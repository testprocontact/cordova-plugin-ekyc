...
SWIFT_CLASS("_TtC4eKYC14DocumentReader") SWIFT_AVAILABILITY(ios,introduced=13)
...
SWIFT_CLASS("_TtC4eKYC13EmirIndicator")
@interface EmirIndicator : UIView
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
...
SWIFT_CLASS("_TtC4eKYC12FCIIndicator")
@interface FCIIndicator : UIView
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder SWIFT_UNAVAILABLE;
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
...
SWIFT_CLASS("_TtC4eKYC19FCILoadingIndicator")
@interface FCILoadingIndicator : UIView
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder SWIFT_UNAVAILABLE;
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC4eKYC11FCIUIButton")
@interface FCIUIButton : UIButton
...
SWIFT_CLASS("_TtC4eKYC5FEKYC")
@interface FEKYC : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
- (nonnull instancetype)initWithConfig:(FEKYCConfig * _Nonnull)config;
+ (void)resetSession;
+ (void)startFPTEKYCFlowWithConfig:(FEKYCConfig * _Nonnull)config from:(UIViewController * _Nonnull)viewController onSuccess:(void (^ _Nonnull)(NSDictionary<NSString *, id> * _Nullable))onSuccess onFail:(void (^ _Nonnull)(NSDictionary<NSString *, id> * _Nullable, NSString * _Nullable))onFail onTracking:(void (^ _Nonnull)(NSString * _Nullable))onTracking;
+ (void)startFPTEKYCFlowLivenessWithConfig:(FEKYCConfig * _Nonnull)config from:(UIViewController * _Nonnull)viewController onSuccess:(void (^ _Nonnull)(NSDictionary<NSString *, id> * _Nullable))onSuccess onFail:(void (^ _Nonnull)(NSDictionary<NSString *, id> * _Nullable, NSString * _Nullable))onFail onTracking:(void (^ _Nonnull)(NSString * _Nullable))onTracking;
@end
...
typedef SWIFT_ENUM(NSInteger, FEKYCCustomer, open) {
  FEKYCCustomerAll = 0,
  FEKYCCustomerEmir = 1,
...
typedef SWIFT_ENUM(NSInteger, FEKYCEnvironment, open) {
  FEKYCEnvironmentProduct = 0,
  FEKYCEnvironmentDev = 1,
  FEKYCEnvironmentStaging = 2,
};
...
typedef SWIFT_ENUM(NSInteger, FEKYCOcrType, open) {
  FEKYCOcrTypeIdCard = 0,
  FEKYCOcrTypeDriveLicense = 1,
  FEKYCOcrTypePassport = 2,
  FEKYCOcrTypeNfc = 3,
};
...
typedef SWIFT_ENUM(NSInteger, FEKYCTypeBack, open) {
  FEKYCTypeBackOcr = 0,
  FEKYCTypeBackNfc = 1,
  FEKYCTypeBackLiveness = 2,
};
...
SWIFT_CLASS("_TtC4eKYC14PassportReader") SWIFT_AVAILABILITY(ios,introduced=13)
...
SWIFT_CLASS("_TtC4eKYC15VuiAppIndicator")
@interface VuiAppIndicator : UIView
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder SWIFT_UNAVAILABLE;
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
